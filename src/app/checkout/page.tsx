...
import { CheckoutProvider, ShippingMethodOptions, VoucherBox, PlaceOrderButton } from "@/components/CheckoutForm";
            ...
            <div className="w-full lg:w-[35%] lg:sticky lg:top-28">
                <div className="bg-white industrial-border rounded-xl overflow-hidden flat-shadow">
                    <div className="p-5 bg-surface-container-low border-b border-border-subtle">
                        <h3 className="text-base md:text-lg font-bold text-primary">Ringkasan Pesanan</h3>
                    </div>
                    ...
                    <div className="p-6 space-y-5">
                        ...
                        <div className="flex gap-4 items-start">
                            <div className="w-20 h-20 bg-bg-alt rounded-lg overflow-hidden flex-shrink-0 border border-border-subtle">
                                <img alt="Nordic Oak Dining Chair" className="w-full h-full object-cover hover:scale-105 transition-transform duration-300" src="https://i.pinimg.com/736x/a0/98/43/a0984398ba783a3e8d658508420d71ed.jpg" />
                            </div>
                            <div className="flex-1 min-w-0">
                                <h4 className="font-bold text-textDark text-sm md:text-base leading-snug truncate">Nordic Oak Dining Chair</h4>
                                <p className="text-xs md:text-sm text-[#737785] font-medium mt-1">Varian: Natural Wood / Qty: 2</p>
                                <p className="text-secondary font-bold text-sm md:text-base mt-1.5">Rp 2.400.000</p>
                            </div>
                        </div>
                        ...
                        <div className="space-y-2.5 text-xs md:text-sm font-medium text-textMuted">
                            <div className="flex justify-between items-center">
                                ...
                                <span className="text-textDark font-semibold">Rp 2.400.000</span>
                            </div>
                            <div className="flex justify-between items-center">
                        ...
                        <div className="flex justify-between items-center py-1">
                            <span className="font-bold text-textDark text-sm md:text-base">Total Keseluruhan</span>
                            <span className="font-extrabold text-secondary text-lg md:text-xl">Rp 2.814.000</span>
                        </div>
                        ...
                        <p className="text-center text-[11px] md:text-[12px] font-medium text-textMuted leading-normal mt-4">
                            Dengan mengeklik tombol di atas, Anda telah menyetujui seluruh <a className="underline text-primary hover:text-opacity-80" href="#">Syarat & Ketentuan</a> serta <a className="underline text-primary hover:text-opacity-80" href="/privacy-policy">Kebijakan Privasi</a> dari Melody Furniture.
                        </p>
                    </div>
                    
                    
                    <div className="bg-bgLight p-4 flex justify-center gap-6 border-t border-borderColor text-textMuted/60">
                        <span className="material-symbols-outlined text-[24px]" title="Terverifikasi Aman">verified_user</span>
                        <span className="material-symbols-outlined text-[24px]" title="Keamanan SSL">security</span>
                        <span className="material-symbols-outlined text-[24px]" title="Pembayaran Terenkripsi">credit_card</span>
                        <span className="material-symbols-outlined text-[24px]" title="Garansi Kualitas Resmi">workspace_premium</span>
                    </div>
                </div>
            </div>
        </div>
